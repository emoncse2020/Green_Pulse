      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-zinc-900 p-10 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="space-y-8 text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          <section>
            ...
            <p>
              Welcome to Green Pulse. By accessing or using our website, platform, and services, you agree to comply with and be bound by these Terms of Service. Please read them carefully.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Users retain ownership of the ideas and content they submit to Green Pulse. However, by submitting content, you grant Green Pulse a worldwide, non-exclusive, royalty-free license to use, display, and distribute that content on our platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Green Pulse is not liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use our platform.
            </p>
          </section>
