      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-zinc-900 p-10 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="space-y-8 text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          <section>
            ...
            <p>
              Green Pulse uses cookies to enhance user experience and analyze website traffic. You can manage cookie settings in your browser at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              If you have any questions or concerns about our Privacy Policy, please contact us at emon.cse.2020@gmail.com.
            </p>
          </section>
        </div>
