    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="container mx-auto px-6 max-w-7xl text-center mb-12">
        <SectionHeader
          ...
          subtitle="Teams trust Green Pulse to build, deploy, and scale reliable projects in the real world."
          badge="Testimonials"
          align="center"
        />
      </div>
      ...
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden gap-4 py-4">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-[#f4f1ea] dark:from-[#07140f]" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-[#f4f1ea] dark:from-[#07140f]" />
      </div>
    </section>
  );
}
