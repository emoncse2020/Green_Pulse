...
import { Send, MapPin, Github, Linkedin, Globe, Mail, Loader2 } from "lucide-react";
...
const ContactForm = () => {
  ...
  const socialLinks = [
    { icon: Globe, href: "https://morsalin.is-a.dev/", label: "Portfolio" },
    { icon: Github, href: "https://github.com/emoncse2020", label: "Github" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/morsalin-ahhamed", label: "Linkedin" },
    { icon: Mail, href: "mailto:emon.cse.2020@gmail.com", label: "Email" },
  ];
             ...
             <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white dark:bg-zinc-950 p-6 rounded-3xl border border-zinc-100 dark:border-zinc-800 shadow-2xl space-y-4">
                   <div className="flex gap-4">
                      ...
                      <div>
                         <h4 className="font-black text-zinc-900 dark:text-white uppercase text-[10px] tracking-widest mb-0.5">Based in Dhaka</h4>
                   ...
                   <div className="flex gap-3">
                      ...
                      <a href="https://morsalin.is-a.dev/" target="_blank" rel="noopener noreferrer" className="flex-1 text-center py-2.5 rounded-xl border border-zinc-100 dark:border-zinc-800 text-xs font-black uppercase tracking-widest hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors text-primary font-black">Visit Portfolio</a>
                   </div>
                </div>
             </div>
          </div>
